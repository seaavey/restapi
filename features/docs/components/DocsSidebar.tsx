...
import { INavigationItem } from '@/features/shared/types/shared';
import { SidebarItem } from '@/features/shared/components/common/item/Sidebar';
import { SidebarSkeleton } from '@/features/shared/components/common/skeleton/Sidebar';
import { useDocsSidebar } from '@/features/docs/contexts/DocsSidebarContext';
...
export default function DocsSidebar() {
    ...
    const fetchSidebar = useCallback(async () => {
        const res = await fetch('/api/v1/sidebar', { cache: 'no-store' });
        return res.json();
    }, []);
